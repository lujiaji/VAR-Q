...
class Args(Tap):
    ...
    enable_sageattn: int = 0  # Whether to enable SageAttention backend in self-attention
    sageattn_type: str = "sageattn"  # SageAttention kernel: 'sageattn' or 'sageattn_qk_int8_pv_fp8_cuda'
