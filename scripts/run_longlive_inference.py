#!/usr/bin/env python3
"""Run LongLive with VAR-Q hooks installed automatically."""
...
from VAR_Q.hooks import install_longlive_hooks
...
def main() -> None:
    ...
    run_upstream_with_hook(
        ...
        install_hook=lambda pipeline: install_longlive_hooks(pipeline, str(config)),
        model_name="LongLive",
    )
